...
public class TentativaPostSemMarcarSpoilerTestCase {
	...
	@Before
	public void setUp() {
		Report.startTest("CafezinhoTentativaPostSemMarcarSpoilerTestCase");
	...
	public void testMain() throws Exception {		    
		...
		Report.log(Status.PASS, "Digitou dados de login", screenshotArquivo1);
		...
		Report.log(Status.PASS, "Digitou dados de login", screenshotArquivo2);
		...
		Report.log(Status.PASS, "Digitou dados de login", screenshotArquivo3);
		...
		Report.log(Status.PASS, "Digitou dados de login", screenshotArquivo4);
		...
		Report.log(Status.PASS, "Clicou em novo post", screenshotArquivo16);
		...
		Report.log(Status.PASS, "Clicou em novo post", screenshotArquivo17);
