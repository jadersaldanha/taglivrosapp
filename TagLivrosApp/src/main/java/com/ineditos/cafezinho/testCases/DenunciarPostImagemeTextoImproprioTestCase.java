...
public class DenunciarPostImagemeTextoImproprioTestCase {
	...
	public void testMain() throws Exception {
		...
		} while (driver.findElement(By.id("br.com.taglivros.tagineditos.debug:id/square_image_view")).isDisplayed());
