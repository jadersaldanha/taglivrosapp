...
public class PostImagemeTextoSpoilerTestCase {
	...
	@Before
	public void setUp() {
		Report.startTest("Post no Cafezinho com Imagem e Texto e Marcado como Spoiler.");
