...
public class PostImagensSpoilerTestCase {
	...
	@Before
	public void setUp() {
		Report.startTest("Post no Cafezinho com Imagens e Texto e Marcado como Spoiler.");
	...
	public void testMain() throws Exception {
		...
		Report.log(Status.PASS, "Clicou em novo post", screenshotArquivo7);
