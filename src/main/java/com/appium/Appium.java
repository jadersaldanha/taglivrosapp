...
//	}
	...
	private static DesiredCapabilities configCapabilities(String deviceName, String appFilePath) {
		...
		capabilities.setCapability("app", "C:\\Users\\Tag Livros\\Downloads\\app-curadoria-debug.apk");
		capabilities.setCapability("appPackage", "br.com.taglivros.taglivros.debug");
		capabilities.setCapability("appActivity", "br.com.taglivros.ui.MainActivity");
		return capabilities;
	}
