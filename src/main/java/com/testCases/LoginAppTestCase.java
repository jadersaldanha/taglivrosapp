...
public class LoginAppTestCase {
	...
	public void testMain() throws InterruptedException, IOException {
		...
		//	br.com.taglivros.taglivros.debug:id/preview_image_view
		
		// Get location of element you want to swipe
	    WebElement banner = driver.findElement(By.id("br.com.taglivros.taglivros.debug:id/preview_image_view"));
		...
		// Get location of element you want to swipe
	    WebElement banner2 = driver.findElement(By.id("br.com.taglivros.taglivros.debug:id/preview_image_view"));
		...
		// Get location of element you want to swipe
	    WebElement banner3 = driver.findElement(By.id("br.com.taglivros.taglivros.debug:id/preview_image_view"));
		...
		// Get location of element you want to swipe
	    WebElement banner4 = driver.findElement(By.id("br.com.taglivros.taglivros.debug:id/preview_image_view"));
		...
		// Get location of element you want to swipe
	    WebElement banner5 = driver.findElement(By.id("br.com.taglivros.taglivros.debug:id/preview_image_view"));
		...
		// Get location of element you want to swipe
	    WebElement banner6 = driver.findElement(By.id("br.com.taglivros.taglivros.debug:id/preview_image_view"));
		...
		// Get location of element you want to swipe
	    WebElement banner7 = driver.findElement(By.id("br.com.taglivros.taglivros.debug:id/preview_image_view"));
		...
		// Get location of element you want to swipe
	    WebElement banner8 = driver.findElement(By.id("br.com.taglivros.taglivros.debug:id/preview_image_view"));
		...
		// Get location of element you want to swipe
	    WebElement banner9 = driver.findElement(By.id("br.com.taglivros.taglivros.debug:id/preview_image_view"));
